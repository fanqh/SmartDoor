...
uint8_t LEDDisplayCode[] = {0xc0,0xf9,0xA4,0xB0,0x99,0x92,0x83,0xF8,0x00,0x98,0x88,0x83,0xc6,0xA1,0x86,0x8E,   0xBF,0xC7, 0x8C, 0xc8,0xc1};
...
{
	 lklt_insert(&seg_led_scan_node, Hal_SEG_LED_Update, NULL, 10/5);
}
...
//					if (!numBlinks) HalSegLedControl.mode |= HAL_SEG_LED_MODE_FLASH;  /* 一直闪烁 */
			...
			case HAL_LED_MODE_FLASH:
					HalSegLedControl.mode  = HAL_LED_MODE_FLASH | HAL_LED_MODE_BLINK;                    /*清除之前的状态*/
					HalSegLedControl.offtime  = 200;                             
					HalSegLedControl.ontime = 200;                             
