...
void RF_Init(void)
{
    delay_us(200);//RFµçÔ´¿¨¿ªºóÖÁÉÙÑÓ³Ù120us,²Å¿ÉÒÔ½øÐÐRFµÄÅäÖÃ£¬·ñÔòÅäÖÃ²»³É¹¦£
...
//    RF_Spi_Config();
    ...
    RF_PcdAntennaOff();//¹Ø±ÕÌìÏß
		...
		lklt_insert(&RF_Scan_Node, RF_Scan_Fun, NULL, 250*TRAV_INTERVAL);  //500ms É¨ÃèÒ»´Î
    //delay_ms(10);
